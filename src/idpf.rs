...
fn extend(seed: &[u8; 16], xof_fixed_key: &XofBlake3Key) -> ([[u8; 16]; 2], [Choice; 2]) {
...
fn generate_correction_word<V>(
    ...
    extend_xof_fixed_key: &XofBlake3Key,
    convert_xof_fixed_key: &XofBlake3Key,
    ...
    VL: IdpfValue,
{
    ...
    pub(crate) fn gen_with_random<M: IntoIterator<Item = VI>>(
        ...
        let extend_xof_fixed_key = XofBlake3Key::new(&extend_dst, binder);
        let convert_xof_fixed_key = XofBlake3Key::new(&convert_dst, binder);
